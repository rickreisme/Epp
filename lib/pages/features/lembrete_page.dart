                        ...
                        itemCount: dados.size,
                          itemBuilder: (context, index) {
                           String id = dados.docs[index].id;
                              ...
                              return Center(
                                child: Text('Nenhum lembrete foi encontrado.', style: 
                                  TextStyle(color: Colors.white, fontFamily: 'Varela Round',
                                  fontSize: 13.sp),
                                ),
                              );
                            }
              ...
              child: Column(
                children: [
                  TextField(
                    controller: lemb,
                    style: TextStyle(
                      color: Color.fromARGB(255, 71, 20, 109), fontFamily: 'Varela Round',
                      fontWeight: FontWeight.w600
                    ),
                    maxLines: 15,
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(color: Color.fromARGB(255, 71, 20, 109),
                        fontFamily: 'Varela Round', fontWeight: FontWeight.w600),
