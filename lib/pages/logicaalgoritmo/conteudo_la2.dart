...
class ConteudoLA2Page extends StatelessWidget {
  const ConteudoLA2Page({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              child: RichText(
                text: TextSpan(
                  children: [
                    TextSpan(
                      text:
                          'Algoritmos: O Caminho Lógico para Resolver Problemas\n\n',
                      style: TextStyle(
                        fontSize:
                    ...
                    TextSpan(
                      text:
                          'Na lógica de programação, o algoritmo pode te ajudar a resolver qualquer problema. Mas o que é exatamente um algoritmo?\n\n'
                          'Imagine algoritmos como receitas passo a passo que fazem sentido e nos levam a um objetivo específico. Vamos ver a seguir exemplos simples do nosso dia a dia.',
                      style: TextStyle(
          ...
          AspectRatio(
            aspectRatio: 16 / 9,
            child: Image.asset('assets/img/algoritm.png', fit: BoxFit.contain),
          ),
          Expanded(
            child: Align(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const ConteudoLA3Page()),
                          );
                        },
                      ),
                    ],
